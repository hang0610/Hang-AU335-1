    ...
    for j = 2:ncols-1
        if ground(i,j)==1
            ...
            if horizontalsum>0 && groundsum==0 && vericalsum==0
                ...
                % dY/dt = nx*dY/dy - ny*dY/dx
                %Aij(:,:,c) = cos(orientation)*[0 0 0; 0 1 0; 0 -1 0] +...
                %(-sin(orientation))*[0 0 0; -1 1 0; 0 0 0];
                %Aij(:,:,c) = sin(orientation)*[0 0 0; 0 1 0; 0 -1 0] +...
                %(-cos(orientation))*[0 0 0; -1 1 0; 0 0 0];
                Aij(:,:,c) = sin(orientation)*[-1 -2 -1; 0 0 0; 1 2 1]/8 +...
                (-cos(orientation))*[-1 0 1; -2 0 2; -1 0 1]/8;
                ii(c) = i; 
                jj(c) = j;
                b(c)  = 0;
            end
